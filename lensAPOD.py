...
def SourceCoord_vals(x, y, x_def, y_def, plate_scale_val, d_s_val, theta_E_val):
    ...
    if foundImage:
        ...
        for i in range(n_x_pix):
            for j in range(n_y_pix):
                x_sou, y_sou = SourceCoord_vals(i, j, x_def, y_def,
                                                plate_scale_val, d_s_val, theta_E_val)
